...
const featureEnvironmentEnum = ['development', 'staging', 'production'] as const
    ...
    environments: {
      ...
      items: {
        ...
        properties: {
          ...
          rolloutPercentage: { type: ['number', 'null'], minimum: 0, maximum: 100 },
  ...
  paths: {
    ...
    '/flags': {
      get: {
        ...
        parameters: [
          { name: 'environment', in: 'query', schema: { type: 'string', enum: featureEnvironmentEnum } },
            ...
            content: {
              'application/json': {
                schema: {
                  type: 'object',
                  properties: {
                    data: { type: 'array', items: { $ref: '#/components/schemas/FeatureFlag' } }
                  }
                }
              }
            }
      ...
      get: {
        ...
        responses: {
          '200': {
            ...
            content: { 'application/json': { schema: { type: 'object', properties: { data: { $ref: '#/components/schemas/FeatureFlag' } } } } }
          },
