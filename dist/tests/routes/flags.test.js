...
const listFlagsMock = listFlags;
const createFlagMock = createFlag;
const getFlagByKeyMock = getFlagByKey;
const updateFlagByKeyMock = updateFlagByKey;
const deleteFlagByKeyMock = deleteFlagByKey;
const logFlagChangeMock = logFlagChange;
const getAuditLogForFlagMock = getAuditLogForFlag;
const sampleFlag = {
	id: "flag-1",
	key: "flag-1",
	name: "My Flag",
